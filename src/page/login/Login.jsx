    ...
    <Meta title={props.title}>
      {!loginData && !loginData.username ? (
        ...
        <form onSubmit={handleSubmit(sendLoginRequest)}>
          <div className={Error || errors.username ? "InputWrapperError" : "InputWrapper"}>
            <input
              ...
              {...register("username", { required: true, pattern: /^[A-Za-z]+$/i, min: 4 })}
            />
          ...
          <div className={Error || errors.password ? "InputWrapperError" : "InputWrapper"}>
            <input
              onFocus={(e) => (e.target.value = "")}
              onClick={inputFocus}
              type="password"
            ...
            {errors.password?.type === 'required' && (
              <span>
                Du skal udfylde dit adgangskode!
              </span>
            )}
